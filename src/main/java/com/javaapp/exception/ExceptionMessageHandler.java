...
import com.javaapp.dto.DefaultExceptionMessageDto;
...
@Order(Ordered.HIGHEST_PRECEDENCE) //before spring throws an exception, highest Precedence goes first
public class ExceptionMessageHandler {
    ...
    private Optional<DefaultExceptionMessageDto> getMessageFromAnnotation(Method method) {
        com.javaapp.annotation.DefaultExceptionMessage defaultExceptionMessage = method.getAnnotation(com.javaapp.annotation.DefaultExceptionMessage.class);
